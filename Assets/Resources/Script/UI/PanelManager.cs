...
public class PanelManager : MonoBehaviour
{
    ...
    //层级列表
    static Dictionary<Layer,Transform> layers=new Dictionary<Layer, Transform>();
    //面板列表
    static Dictionary<string,BasePanel> panels=new Dictionary<string, BasePanel>();
    ...
    //打开面板
    //其中where T:BasePanel代表T必须为BasePanel的子类
